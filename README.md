...
4. When these are completed, the function generate_octave() can be used to visualize the results.

Included in this repository is an R script, "sample_analysis.R" and accompanying data that shows how these can be used to replicate the results from the accompanying paper and can be used as a starting point for your own validations.  The behavior of the functions is described in detail below:
